// Fixture data for the compose screen. There is no server.

/** Mention targets for the RichTextKit mention extension. */
export const people = [
...
export const initialTitle = 'Design review: new onboarding flow'
...
export const initialContent = `
  ...
  <p>One thing to sort out on the backend: the checklist state has to persist per user, not per session. Right now the prototype reads it from <code>browser storage</code>, which resets when you switch devices. Here is the response shape I am proposing:</p>
